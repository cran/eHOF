...
#' @param newdata new gradient vector, if NULL a vector with 10000 values within gradient range will be used.
#' @param model response model type. If not specified, the output of [pick.model()] will be used.
#' @param p Vector of model parameters. If not specified, resp$models[[model]]$par will be used.
#' @param type Output type: slope or inflection points of model curves.
